...
|-----------|-----------|-----------|-----------|-----------|
| i10  |ff42|34| KND/Wallsplat MM| $${\color{red}Сложно}$$, $${\color{green}Оптимальный}$$ (см.секцию под таблицами про ff42)|
| i10  |122|23| +5 HHH||
| i10  |122~b|23| BT+5 HHH |$${\color{green}Стейпл}$$|
| i10  |11|17| +6 HM|Вероятно, может использоваться в ситуациях если персонаж противника может отменять рекавери в хайкраш стойку и второй удар его ловит для опшен селектов в 112, _проверить ws3 Анны, b4,1+2 Лео_|
| i10  |11,1+2|17| KAT+4 HM |Для разыгровок из KAT|
...
| Стартап  | Нотация | Урон | Св-ва | Примечание |
|-----------|-----------|-----------|-----------|-----------|
| i10  | ff42  |34|MM KND/Wallsplat|$${\color{red}Сложно}$$, $${\color{green}Оптимальный}$$|
| i11  | ws4  |15|+5 M | |
| i12  | ws1,1  |26|+8 MM| |
